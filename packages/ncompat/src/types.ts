...
export type Page = Extract<Awaited<ReturnType<InstanceType<typeof Client>['pages']['retrieve']>>, { url: string }>
...
export type RichText = Extract<Block, { type: 'paragraph' }>['paragraph']['rich_text']
